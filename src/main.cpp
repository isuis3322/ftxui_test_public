...
// configuration step. It creates a namespace called `ftxui_test_public`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ftxui_test_public::cmake::project_name, ftxui_test_public::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ftxui_test_public::cmake::project_version);
      return EXIT_SUCCESS;
    }
